...
summarise_solar_radiation <- function(.x, value_var, normals_df){
  ...
  suppressMessages(
    ...
    dplyr::summarise(
      ...
      dark_3 = nseq::trle_cond(x = {{value_var}}, a = 3, a_op = "gte", b = .data[["normal"]], b_op = "lte"),
      dark_5 = nseq::trle_cond(x = {{value_var}}, a = 5, a_op = "gte", b = .data[["normal"]], b_op = "lte"),
      light_3 = nseq::trle_cond(x = {{value_var}}, a = 3, a_op = "gte", b = .data[["normal"]], b_op = "gte"),
      light_5 = nseq::trle_cond(x = {{value_var}}, a = 5, a_op = "gte", b = .data[["normal"]], b_op = "gte"),
    )
  ) 
}
