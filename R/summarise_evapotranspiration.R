...
summarise_evapotrapiration <- function(.x, value_var, normals_df){
  ...
  suppressMessages(
    ...
    dplyr::summarise(
      ...
      l_eto_3 = nseq::trle_cond(x = {{value_var}}, a = 3, a_op = "gte", b = .data[["normal_mean"]], b_op = "lte"),
      l_eto_5 = nseq::trle_cond(x = {{value_var}}, a = 5, a_op = "gte", b = .data[["normal_mean"]], b_op = "lte"),
      h_eto_3 = nseq::trle_cond(x = {{value_var}}, a = 3, a_op = "gte", b = .data[["normal_mean"]], b_op = "gte"),
      h_eto_5 = nseq::trle_cond(x = {{value_var}}, a = 5, a_op = "gte", b = .data[["normal_mean"]], b_op = "gte"),
    )
  ) 
}
