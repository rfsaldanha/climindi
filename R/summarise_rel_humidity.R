...
#'  \item{`dry_days` Count of dry days, when the relative humidity is bellow the 10th percentile}
#'  \item{`wet_days` Count of wet days, when the relative humidity is above the 90th percentile}
...
summarise_rel_humidity <- function(.x, value_var, normals_df){
  ...
  suppressMessages(
    ...
    dplyr::summarise(
      ...
      dry_spells_3d = nseq::trle_cond(x = {{value_var}}, a = 3, a_op = "gte", b = .data[["normal"]] - 10, b_op = "lte"),
      dry_spells_5d = nseq::trle_cond(x = {{value_var}}, a = 5, a_op = "gte", b = .data[["normal"]] - 10, b_op = "lte"),
      wet_spells_3d = nseq::trle_cond(x = {{value_var}}, a = 3, a_op = "gte", b = .data[["normal"]] + 10, b_op = "gte"),
      wet_spells_5d = nseq::trle_cond(x = {{value_var}}, a = 5, a_op = "gte", b = .data[["normal"]] + 10, b_op = "gte"),
      dry_days = nseq::trle_cond(x = {{value_var}}, a = 1, a_op = "gte", b = .data[["p_10"]], b_op = "lte"),
      wet_days = nseq::trle_cond(x = {{value_var}}, a = 1, a_op = "gte", b = .data[["p_90"]], b_op = "gte"),
