...
On this example, the function
[`summarise_normal()`](https://rfsaldanha.github.io/climindi/reference/summarise_normal.md)
will receive the grouped data by municipality id and month, and compute
the climatological monthly normal considering the values between 1961
and 1990.
...
computes a total of 19 indicators. Let’s plot one of them.
